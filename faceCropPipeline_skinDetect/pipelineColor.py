...
# frame = cv2.imread("../data/chris.jpg")
# gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
# MINSIZE = (80,80)
...
skinFrame = cv2.cvtColor(skinFrame, cv2.COLOR_BGR2HSV)
# cv2.imshow("skinFrame HSV",skinFrame) #hsv skin frame
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
headFrame = cv2.cvtColor(headFrame, cv2.COLOR_BGR2HSV)
...
skinMask = cv2.inRange(headFrame, lower, upper)
